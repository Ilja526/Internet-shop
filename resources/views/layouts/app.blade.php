                    ...
                    <div class="card-deck mb-3 text-center">
                        <div class="card mb-4 box-shadow">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ url("unique") }}"><button type="button" class="btn btn-lg btn-block btn-outline-primary" data-toggle="modal" data-target="#signup-modal">Free</button></a>
                            </div>
                        </div>
                        <div class="card mb-4 box-shadow">
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ url("unique") }}"><button type="button" class="btn btn-lg btn-block btn-outline-primary" data-toggle="modal" data-target="#signup-modal">Buy for 15€</button></a>
                            </div>
                        </div>
                        <div class="card mb-4 box-shadow">
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ url("unique") }}"><button type="button" class="btn btn-lg btn-block btn-outline-primary" data-toggle="modal" data-target="#signup-modal">Buy for 29€</button></a>
                            </div>
                        </div>
                    </div>
                </div>
