            ...
            <main role="main">
                ...
                <div class="container marketing">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <img class="rounded-circle" src="{{ asset('img/plits.jpg') }}" alt="Generic placeholder image" width="100" height="140">
                        ...
                        <div class="col-lg-4">
                            <img class="rounded-circle" src="{{ asset('img/datorspele.jpg') }}" alt="Generic placeholder image" width="100" height="140">
